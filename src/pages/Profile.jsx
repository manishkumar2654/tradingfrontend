  ...
  return (
    <div className="bg-[#0b1220] min-h-screen text-slate-100 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* HEADER */}
        <h3 className="text-3xl font-bold text-center mb-8">User Profile</h3>

        {/* BASIC INFO */}
        <div className="bg-[#0f172a] border border-gray-800 rounded-2xl shadow-md mb-6 p-6">
          <h6 className="text-white font-semibold mb-4">Basic Information</h6>
          <div className="space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-400 font-medium">Client Code</span>
              <span className="text-slate-100">ABC123</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400 font-medium">Name</span>
              <span className="text-slate-100">Demo User</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400 font-medium">Email</span>
              <span className="text-slate-100">demo@email.com</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400 font-medium">Mobile No</span>
              <span className="text-slate-100">9876543210</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400 font-medium">Broker ID</span>
              <span className="text-slate-100">B2C</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-400 font-medium">Last Login</span>
              <span className="text-slate-100">04 Feb 2026, 10:30 AM</span>
            </div>
          </div>
        </div>
        ...
        {/* EXCHANGES ALLOWED */}
        <div className="bg-[#0f172a] border border-gray-800 rounded-2xl shadow-md mb-6 p-6">
          <h6 className="text-white font-semibold mb-4">Exchanges Allowed</h6>
          <div className="flex flex-wrap gap-2">
            {["NSE", "BSE", "MCX", "CDS", "NCDEX", "NFO"].map((ex, i) => (
              <span
                key={i}
        ...
        {/* PRODUCTS ENABLED */}
        <div className="bg-[#0f172a] border border-gray-800 rounded-2xl shadow-md mb-6 p-6">
          <h6 className="text-white font-semibold mb-4">Products Enabled</h6>
          <div className="flex flex-wrap gap-2">
            {["DELIVERY", "INTRADAY", "MARGIN"].map((prod, i) => (
              <span
                key={i}
        ...
        <p className="text-center text-gray-400 text-sm">
          This is a demo profile screen with static data.
        </p>
